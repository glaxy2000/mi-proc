...
export default function Layout({ children, currentPageName }) {
  ...
  const authPages = ['Home', 'Products', 'Solutions', 'BuyerSignin', 'BuyerSignup', 'SupplierSignin', 'SupplierSignup', 'AuthBuyer', 'AuthSupplier', 'AdminSignin', 'SupplierOnboarding', 'BuyerOnboarding', 'Contact', 'Signin', 'Register', 'ProcurementServices', 'Automation', 'DigitalTransformation', 'CostOptimisation'];
