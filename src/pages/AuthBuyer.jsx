...
export default function AuthBuyer() {
  ...
  const handleSignup = (e) => {
    ...
    if (!signupData.organizationType) newErrors.organizationType = 'Organisation type is required';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Sign in or create your buyer account</p>
        </div>

        <Card className="border-0 shadow-xl">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <CardHeader className="bg-gradient-to-r from-teal-50 to-indigo-50 border-b pb-0">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-1">Access your procurement dashboard</p>
                </div>
              </div>
              ...
              <TabsContent value="signin">
                <form onSubmit={handleSignin} className="space-y-6">
                  ...
                  <div className="text-center text-sm text-slate-600">
                    Are you a supplier?{' '}
                    <Link to={createPageUrl('AuthSupplier')} className="text-indigo-600 hover:underline font-medium">
                ...
                <form onSubmit={handleSignup} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setSignupData({ ...signupData, organizationType: value })}
                    >
                      <SelectTrigger className={signupErrors.organizationType ? 'border-red-500' : ''}>
                  ...
                  <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                    <div className="flex items-start gap-3">
                      ...
                      />
                      <div>
                        <Label htmlFor="registerAsBoth" className="text-sm font-medium text-indigo-900">
                          Also register as a Supplier
                        </Label>
                        <p className="text-xs text-indigo-700 mt-1">
                          Check this if you want to both purchase and sell on the platform
                        </p>
                      </div>
                    </div>
                  </div>
