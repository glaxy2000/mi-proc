...
export default function SupplierOnboarding() {
  ...
  const generateRandomCompanyData = (crNumber) => {
    const companies = [
      { arabic: 'شركة الصناعات السعودية المتقدمة', english: 'Saudi Advanced Industries Co.', sector: 'manufacturing', city: 'riyadh', street: 'King Fahd Industrial City, Block 4', postal: '11564', nationalAddress: 'KFIC7741', phone: '+966 11 234 5678', email: 'info@saic.com.sa', website: 'https://www.saic.com.sa', employees: '100+', years: '12', primary: 'Manufacturing of industrial equipment, metal fabrication, and structural steel components for construction and oil & gas sectors.', secondary: 'Maintenance, repair, and overhaul (MRO) services for heavy machinery and equipment.' },
      { arabic: 'شركة تقنية المعلومات المتكاملة', english: 'Integrated IT Solutions Ltd.', sector: 'other', city: 'jeddah', street: 'Prince Sultan Road, Al Hamra District', postal: '21451', nationalAddress: 'HMRA2256', phone: '+966 12 345 6789', email: 'sales@iits.com.sa', website: 'https://www.iits.com.sa', employees: '21-50', years: '8', primary: 'Enterprise software solutions, cloud computing, cybersecurity, and IT infrastructure management.', secondary: 'IT training, managed services, and technical support for corporate clients.' },
      { arabic: 'مؤسسة الإنشاءات الحديثة', english: 'Modern Construction Est.', sector: 'construction', city: 'dammam', street: '2nd Industrial Street, Jubail Industrial City', postal: '31952', nationalAddress: 'JBIL8834', phone: '+966 13 456 7890', email: 'contracts@modern-const.com.sa', website: 'https://www.modern-const.com.sa', employees: '51-100', years: '15', primary: 'Civil construction, building contracting, and infrastructure development for residential and commercial projects.', secondary: 'Project management consultancy and quantity surveying services.' },
      { arabic: 'شركة الأدوية السعودية الموحدة', english: 'United Saudi Pharma Co.', sector: 'healthcare', city: 'riyadh', street: 'Olaya District, Al Tahlia Street', postal: '12211', nationalAddress: 'OLYA5590', phone: '+966 11 567 8901', email: 'procurement@uspc.com.sa', website: 'https://www.uspc.com.sa', employees: '100+', years: '20', primary: 'Distribution of pharmaceutical products, medical devices, and laboratory consumables across Saudi Arabia.', secondary: 'Healthcare consultancy and regulatory affairs services for medical companies.' },
      { arabic: 'شركة النقل والتوزيع الخليجية', english: 'Gulf Transport & Distribution Co.', sector: 'logistics', city: 'khobar', street: 'King Abdulaziz Road, Industrial Area', postal: '34445', nationalAddress: 'DMAG3000', phone: '+966 13 678 9012', email: 'ops@gtdc.com.sa', website: 'https://www.gtdc.com.sa', employees: '6-20', years: '6', primary: 'Land freight transportation, last-mile delivery, and warehousing solutions across the GCC region.', secondary: 'Cold chain logistics and hazardous materials transport with SFDA compliance.' },
    ];
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  {/^\d{10}$/.test(formData.crNumber) && (
                    <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4 flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-indigo-800">CR Integration Active — Documents Auto-Attached</p>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          <Badge className="bg-indigo-100 text-indigo-700">MoC API v2.1</Badge>
                          <Badge className="bg-indigo-100 text-indigo-700">ZATCA Verified</Badge>
                          <Badge className="bg-indigo-100 text-indigo-700">Live Registry</Badge>
                        </div>
                      </div>
                    </div>
                  )}
